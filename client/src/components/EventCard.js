...
import { clearErrors, clearMessage, eventDetails, registerEvent } from '../actions/event';
...
export default function EventCard() {
   ...
   const [speackeravatar, setSpeakerAvatar] = useState("");
   ...
   useEffect(() => {
      dispatch(eventDetails(params.id));
                     ...
                     event && <div className="">
                        ...
                        <div className='w-[100vw]  sticky top-0 bg-gray-100 z-10'>
                           <div className='w-[65%] mx-auto  bg-gray-100'>
                              <button className='p-2 rounded-md my-2 bg-red-500 text-white ' onClick={updateHandler}> Update</button>
                           </div>
                        </div>
                        ...
                        <form className="w-[100%]  flex flex-col items-center justify-center" encType="multipart/form-data" >
                           <div className='bg-blue-200 w-[100vw] flex flex-col items-center justify-center py-5 pb-24'>
                              ...
                              <input className=' w-[50%] py-3 px-5 mx-auto outline-none bg-transparent text-center text-3xl font-medium' type="text" placeholder="Enter a Short, Descriptive Title" required value={shortTitle} onChange={(e) => setshortTitle(e.target.value)} />
